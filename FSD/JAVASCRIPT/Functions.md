- reusable piece of code to perform a task
- executed upon calling (invoking)
...
```
### parameters
- placeholder for the values that will be passed to the function when it is called. 
---
